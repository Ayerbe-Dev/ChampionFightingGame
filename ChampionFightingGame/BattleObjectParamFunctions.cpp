...
int BattleObject::get_local_param_int(std::string param) {
	return get_local_param_int(param, stats);
}

int BattleObject::get_local_param_int(std::string param, ParamTable param_table) {
...
float BattleObject::get_local_param_float(std::string param) {
	return get_local_param_float(param, stats);
}

float BattleObject::get_local_param_float(std::string param, ParamTable param_table) {
...
std::string BattleObject::get_local_param_string(std::string param) {
	return get_local_param_string(param, stats);
}

std::string BattleObject::get_local_param_string(std::string param, ParamTable param_table) {
...
bool BattleObject::get_local_param_bool(std::string param) {
	return get_local_param_bool(param, stats);
}

bool BattleObject::get_local_param_bool(std::string param, ParamTable param_table) {
