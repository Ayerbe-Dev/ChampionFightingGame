...
const unsigned int BUTTON_MENU_PAGE_LEFT = 24;
const unsigned int BUTTON_MENU_PAGE_RIGHT = 25;
const unsigned int BUTTON_MENU_FRAME_PAUSE = 26;
const unsigned int BUTTON_MENU_FRAME_ADVANCE = 27;
const unsigned int BUTTON_MENU_RECORD_INPUT = 28;
const unsigned int BUTTON_MENU_REPLAY_INPUT = 29;
const unsigned int BUTTON_MENU_SWITCH_INPUT = 30;
const unsigned int BUTTON_MENU_MAX = 31;
