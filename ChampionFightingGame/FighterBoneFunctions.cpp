...
glm::vec3 Fighter::get_relative_bone_position(std::string bone_name, glm::vec3 offset) {
...
glm::vec3 Fighter::get_bone_position(std::string bone_name, glm::vec3 offset) {
	int index = model.get_bone_id(bone_name);
	if (index != -1) {
...
glm::vec3 Fighter::get_bone_position(int bone_id, glm::vec3 offset) {
...
glm::vec3 Fighter::get_rotated_relative_bone_position(std::string bone_name, glm::vec3 offset) {
	int index = model.get_bone_id(bone_name);
	if (index != -1) {
...
glm::vec3 Fighter::get_rotated_relative_bone_position(int bone_id, glm::vec3 offset) {
