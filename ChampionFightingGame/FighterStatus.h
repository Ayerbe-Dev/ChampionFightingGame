...
enum {
	...
	_FIGHTER_STATUS_WALKF,
	_FIGHTER_STATUS_WALKB,
	_FIGHTER_STATUS_DASH,
	_FIGHTER_STATUS_DASHB,
	_FIGHTER_STATUS_DASH_AIR,
	_FIGHTER_STATUS_CROUCHD,
	_FIGHTER_STATUS_CROUCH,
	_FIGHTER_STATUS_CROUCHU,
...
const int FIGHTER_STATUS_WALKF = _FIGHTER_STATUS_WALKF;
const int FIGHTER_STATUS_WALKB = _FIGHTER_STATUS_WALKB;
const int FIGHTER_STATUS_DASH = _FIGHTER_STATUS_DASH;
const int FIGHTER_STATUS_DASHB = _FIGHTER_STATUS_DASHB;
const int FIGHTER_STATUS_DASH_AIR = _FIGHTER_STATUS_DASH_AIR;
const int FIGHTER_STATUS_CROUCHD = _FIGHTER_STATUS_CROUCHD;
const int FIGHTER_STATUS_CROUCH = _FIGHTER_STATUS_CROUCH;
const int FIGHTER_STATUS_CROUCHU = _FIGHTER_STATUS_CROUCHU;
...
const int FIGHTER_STATUS_HITSTUN_PARRY = _FIGHTER_STATUS_HITSTUN_PARRY;
