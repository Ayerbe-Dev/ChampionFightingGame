...
const int FIGHTER_STATUS_BACKDASH_ATTACK = _FIGHTER_STATUS_BACKDASH_ATTACK;
...
const int FIGHTER_STATUS_GRAB_START = _FIGHTER_STATUS_GRAB_START;
const int FIGHTER_STATUS_GRAB = _FIGHTER_STATUS_GRAB;
const int FIGHTER_STATUS_THROW = _FIGHTER_STATUS_THROW;
const int FIGHTER_STATUS_GRAB_AIR_START = _FIGHTER_STATUS_GRAB_AIR_START;
...
const int FIGHTER_STATUS_KO = _FIGHTER_STATUS_KO;
