			...
			switch (owner->fighter_int[FIGHTER_INT_SPECIAL_LEVEL]) {
				case (SPECIAL_LEVEL_EX): {
					push_function(&Projectile::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, 
						...
						HIT_STATUS_LAUNCH, MoveOpponent().ground(0.0, 10.0).frames(5)
			...
			switch (owner->fighter_int[FIGHTER_INT_SPECIAL_LEVEL]) {
				case (SPECIAL_LEVEL_EX): {
					push_function(&Projectile::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, 
						...
						HIT_STATUS_NORMAL, MoveOpponent().ground(8.0, 8.0).air(3.0, 5.0).frames(9)
					...
					push_function(&Projectile::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 1, 
						...
						HIT_STATUS_NORMAL, MoveOpponent().ground(18.0, 18.0).air(8.0, 25.0).frames(9)
						...
						DAMAGE_KIND_CHIP, HIT_LEVEL_LIGHT, "", ""
					);
				} break;
				case (SPECIAL_LEVEL_H): {
					push_function(&Projectile::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, 
