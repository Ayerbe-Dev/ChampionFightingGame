...
void Rowan::load_move_scripts() {
	...
	script("wait", [this]() {
		execute_frame(0, [this]() {
			...
			push_function(&Fighter::NEW_HURTBOX, 0, glm::vec2(-80, 0), glm::vec2(120, 150));
			push_function(&Fighter::NEW_HURTBOX, 1, glm::vec2(-30, 150), glm::vec2(70, 180));
		});
	...
	script("parry_start_high", [this]() {
		...
		execute_wait(7, [this]() {
			...
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_IN_ENDLAG, true);
			});
		});
	...
	script("stand_lp", [this]() {
		...
		execute_frame(4, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 30.0, /*Chip Damage*/ 6.0, /*Damage Scale*/ 1, /*Meter Gain*/ 24.0, glm::vec2(5, 145), glm::vec2(200, 165), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_LIGHT, ATTACK_HEIGHT_MID, /*Hitlag*/ 8, /*Blocklag*/ 8, /*Hitstun*/ 14, /*Blockstun*/ 12, /*Hit Pushback*/ 10.0, /*Block Pushback*/ 10.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 1, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 0.0, 0.0, 0.0, 0.0);
		});
		execute_wait(4, [this]() {
	...
	script("stand_hp", [this]() {
		...
		execute_frame(7, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 50.0, /*Chip Damage*/ 10.0, /*Damage Scale*/ 1, /*Meter Gain*/ 40.0, glm::vec2(180, 168), glm::vec2(12, 128), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_HEAVY, ATTACK_HEIGHT_MID, /*Hitlag*/ 12, /*Blocklag*/ 16, /*Hitstun*/ 23, /*Blockstun*/ 23, /*Hit Pushback*/ 14.0, /*Block Pushback*/ 8.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 2, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ true, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 20.0, 1.3, 15.0, 25.0);
		});
		execute_wait(5, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("stand_lk", [this]() {
		...
		execute_frame(4, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 30.0, /*Chip Damage*/ 6.0, /*Damage Scale*/ 1, /*Meter Gain*/ 24.0, glm::vec2(250, 57), glm::vec2(13, 4), HIT_KIND_GROUND, ATTACK_LEVEL_LIGHT, ATTACK_HEIGHT_MID, /*Hitlag*/ 8, /*Blocklag*/ 8, /*Hitstun*/ 12, /*Blockstun*/ 10, /*Hit Pushback*/ 10.0, /*Block Pushback*/ 10.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 0, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 10.0, 0.0, 0.0, 1.0);
		});
		execute_wait(3, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("stand_mk", [this]() {
		...
		execute_frame(7, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 40.0, /*Chip Damage*/ 8.0, /*Damage Scale*/ 1, /*Meter Gain*/ 32.0, glm::vec2(30, 105), glm::vec2(310, 155), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_MID, /*Hitlag*/ 10, /*Blocklag*/ 12, /*Hitstun*/ 15, /*Blockstun*/ 10, /*Hit Pushback*/ 19.0, /*Block Pushback*/ 15.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 2, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ true, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 10.0, 0.0, 0.0, 1.0);
		});
		execute_wait(1, [this]() {
	...
	script("stand_hk", [this]() {
		...
		execute_frame(12, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 50.0, /*Chip Damage*/ 25.0, /*Damage Scale*/ 1, /*Meter Gain*/ 40.0, glm::vec2(370, 190), glm::vec2(180, 130), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_HEAVY, ATTACK_HEIGHT_MID, /*Hitlag*/ 12, /*Blocklag*/ 16, /*Hitstun*/ 27, /*Blockstun*/ 20, /*Hit Pushback*/ 15.0, /*Block Pushback*/ 10.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_LAUNCH, COUNTERHIT_TYPE_PUNISH_ONLY, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 4, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ true, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 30.000000, 0.000000, 0.000000, 4.000000);
		});
		execute_wait(2, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("crouch_mp", [this]() {
		...
		execute_wait(2, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 0, /*Damage*/ 40.0, /*Chip Damage*/ 4.0, /*Damage Scale*/ 1, /*Meter Gain*/ 32.0, glm::vec2(255, 120), glm::vec2(355, 165), HIT_KIND_AIR, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_MID, /*Hitlag*/ 10, /*Blocklag*/ 0, /*Hitstun*/ 22, /*Blockstun*/ 0, /*Hit Pushback*/ 24.0, /*Block Pushback*/ 8.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 3, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 10.0, 0.0, 0.0, 1.0);
		});
		execute_wait(4, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("crouch_hp", [this]() {
		...
		execute_wait(2, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 50.0, /*Chip Damage*/ 5.0, /*Damage Scale*/ 1, /*Meter Gain*/ 40.0, glm::vec2(51, 253), glm::vec2(149, 70), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_HEAVY, ATTACK_HEIGHT_MID, /*Hitlag*/ 12, /*Blocklag*/ 16, /*Hitstun*/ 22, /*Blockstun*/ 16, /*Hit Pushback*/ 6.0, /*Block Pushback*/ 4.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_LAUNCH, COUNTERHIT_TYPE_AERIAL_ONLY, /*Juggle Start*/ 1, /*Juggle Increase*/ 1, /*Juggle Max*/ 1, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ true, /*Disable Hitstun Parry*/ true, /*Launch Info*/ 28.0, 0.0, 0.0, 7.0);
		});
		execute_wait(1, [this]() {
	...
	script("crouch_lk", [this]() {
		...
		execute_frame(3, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 30.0, /*Chip Damage*/ 3.0, /*Damage Scale*/ 2, /*Meter Gain*/ 24.0, glm::vec2(230, 36), glm::vec2(129, -7), HIT_KIND_GROUND, ATTACK_LEVEL_LIGHT, ATTACK_HEIGHT_LOW, /*Hitlag*/ 8, /*Blocklag*/ 8, /*Hitstun*/ 11, /*Blockstun*/ 13, /*Hit Pushback*/ 15.0, /*Block Pushback*/ 15.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 0, /*Juggle Max*/ 0, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 10.0, 0.0, 0.0, 1.0);
		});
		execute_wait(3, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("crouch_mk", [this]() {
		...
		execute_frame(6, [this]() {
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 40.0, /*Chip Damage*/ 6.0, /*Damage Scale*/ 1, /*Meter Gain*/ 32.0, glm::vec2(293, -10), glm::vec2(14, 42), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_LOW, /*Hitlag*/ 10, /*Blocklag*/ 12, /*Hitstun*/ 19, /*Blockstun*/ 13, /*Hit Pushback*/ 14.0, /*Block Pushback*/ 8.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 0, /*Juggle Max*/ 0, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 10.0, 0.0, 0.0, 1.0);
		});
		execute_wait(5, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("jump_mp", [this]() {
		...
		execute_frame(6, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 40.0, /*Chip Damage*/ 4.0, /*Damage Scale*/ 1, /*Meter Gain*/ 32.0, glm::vec2(90, 5), glm::vec2(215, 50), HIT_KIND_GROUND, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_HIGH, /*Hitlag*/ 10, /*Blocklag*/ 12, /*Hitstun*/ 21, /*Blockstun*/ 26, /*Hit Pushback*/ 22.0, /*Block Pushback*/ 22.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 1, /*Juggle Increase*/ 1, /*Juggle Max*/ 4, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 10.0, 0.0, 0.0, 1.0);
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 0, /*Damage*/ 40.0, /*Chip Damage*/ 4.0, /*Damage Scale*/ 1, /*Meter Gain*/ 32.0, glm::vec2(90, 5), glm::vec2(215, 50), HIT_KIND_AIR, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_HIGH, /*Hitlag*/ 10, /*Blocklag*/ 12, /*Hitstun*/ 21, /*Blockstun*/ 26, /*Hit Pushback*/ 18.0, /*Block Pushback*/ 18.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 1, /*Juggle Increase*/ 1, /*Juggle Max*/ 4, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 10.0, 0.0, 0.0, 1.0);
		});
		execute_wait(8, [this]() {
			push_function(&Fighter::CLEAR_HURTBOX, 1);
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("special_slide", [this]() {
		...
		execute_frame(12, [this]() {
			...
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] == SPECIAL_LEVEL_EX) {
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 70.0, /*Chip Damage*/ 14.0, /*Damage Scale*/ 1, /*Meter Gain*/ 0.0, glm::vec2(0, -12), glm::vec2(250, 30), HIT_KIND_GROUND, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_LOW, /*Hitlag*/ 12, /*Blocklag*/ 12, /*Hitstun*/ 40, /*Blockstun*/ 19, /*Hit Pushback*/ 0.000000, /*Block Pushback*/ 15.000000, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 0, /*Juggle Max*/ 0, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ true, /*Launch Init Y Speed*/ 0.000000, /*Launch Gravity*/ 0.000000, /*Launch Max Fall Speed*/ 0.000000, /*Launch X Speed*/ 0.000000, /*Use Player Pos*/ true);
			}
			else {
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 70.0, /*Chip Damage*/ 14.0, /*Damage Scale*/ 1, /*Meter Gain*/ 56.0, glm::vec2(0, -12), glm::vec2(250, 30), HIT_KIND_GROUND, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_LOW, /*Hitlag*/ 12, /*Blocklag*/ 12, /*Hitstun*/ 40, /*Blockstun*/ 16, /*Hit Pushback*/ 0.000000, /*Block Pushback*/ 15.000000, /*Hit Status*/ HIT_STATUS_KNOCKDOWN, /*Counterhit Status*/ HIT_STATUS_KNOCKDOWN, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 0, /*Juggle Max*/ 0, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ true, /*Launch Init Y Speed*/ 0.000000, /*Launch Gravity*/ 0.000000, /*Launch Max Fall Speed*/ 0.000000, /*Launch X Speed*/ 0.000000, /*Use Player Pos*/ true);
			}
		});
		execute_wait(3, [this]() {
	...
	script("special_slide_followup", [this]() {
		...
		execute_frame(8.0, [this]() {
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] == SPECIAL_LEVEL_EX) {
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 70.0, /*Chip Damage*/ 14.0, /*Damage Scale*/ 1, /*Meter Gain*/ 0.0, glm::vec2(62, 45), glm::vec2(201, 236), HIT_KIND_AIR, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_MID, /*Hitlag*/ 12, /*Blocklag*/ 16, /*Hitstun*/ 52, /*Blockstun*/ 30, /*Hit Pushback*/ 0.0, /*Block Pushback*/ 15.0, /*Hit Status*/ HIT_STATUS_LAUNCH, /*Counterhit Status*/ HIT_STATUS_LAUNCH, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 4, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ true, /*Disable Hitstun Parry*/ false, /*Launch Init Y Speed*/ 38.0, /*Launch Gravity*/ 2.0, /*Launch Max Fall Speed*/ 18.0, /*Launch X Speed*/ 4.0, /*Use Player Pos*/ true);
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 0, /*Damage*/ 70.0, /*Chip Damage*/ 14.0, /*Damage Scale*/ 1, /*Meter Gain*/ 0.0, glm::vec2(62, 45), glm::vec2(201, 236), HIT_KIND_GROUND, ATTACK_LEVEL_MEDIUM, ATTACK_HEIGHT_MID, /*Hitlag*/ 12, /*Blocklag*/ 16, /*Hitstun*/ 52, /*Blockstun*/ 30, /*Hit Pushback*/ 0.0, /*Block Pushback*/ 15.0, /*Hit Status*/ HIT_STATUS_LAUNCH, /*Counterhit Status*/ HIT_STATUS_LAUNCH, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 4, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ true, /*Disable Hitstun Parry*/ false, /*Launch Init Y Speed*/ 45.0, /*Launch Gravity*/ 2.0, /*Launch Max Fall Speed*/ 18.0, /*Launch X Speed*/ 3.5, /*Use Player Pos*/ true);
			}
			else {
	...
	script("special_uppercut_start", [this]() {
		...
		execute_frame(4, [this]() {
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] == SPECIAL_LEVEL_L) {
				...
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 30.0, /*Chip Damage*/ 6.0, /*Damage Scale*/ 1, /*Meter Gain*/ 24.0, glm::vec2(220, 0), glm::vec2(160, 120), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_LIGHT, ATTACK_HEIGHT_MID, /*Hitlag*/ 12, /*Blocklag*/ 8, /*Hitstun*/ 38, /*Blockstun*/ 17, /*Hit Pushback*/ -10.0, /*Block Pushback*/ 10.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 5, /*Juggle Increase*/ 1, /*Juggle Max*/ 4, CLANK_KIND_CONTINUE, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ true, /*Launch Init Y Speed*/ 0.0, /*Launch Gravity*/ 0.0, /*Launch Max Fall Speed*/ 0.0, /*Launch X Speed*/ 0.0, /*Use Player Pos*/ true);
			}
			else {
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 30.0, /*Chip Damage*/ 6.0, /*Damage Scale*/ 1, /*Meter Gain*/ 0.0, glm::vec2(220, 0), glm::vec2(160, 120), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_LIGHT, ATTACK_HEIGHT_MID, /*Hitlag*/ 12, /*Blocklag*/ 8, /*Hitstun*/ 38, /*Blockstun*/ 17, /*Hit Pushback*/ -10.0, /*Block Pushback*/ 10.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 5, /*Juggle Increase*/ 1, /*Juggle Max*/ 7, CLANK_KIND_CONTINUE, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ true, /*Launch Init Y Speed*/ 0.0, /*Launch Gravity*/ 0.0, /*Launch Max Fall Speed*/ 0.0, /*Launch X Speed*/ 0.0, /*Use Player Pos*/ true);
			}
		});
		execute_wait(4, [this]() {
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("special_uppercut", [this]() {
		...
		execute_frame(4, [this]() {
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] == SPECIAL_LEVEL_L) {
				...
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 90.0, /*Chip Damage*/ 18.0, /*Damage Scale*/ 1, /*Meter Gain*/ 0.0, glm::vec2(47, 30), glm::vec2(177, 194), HIT_KIND_GROUND | HIT_KIND_AIR, ATTACK_LEVEL_HEAVY, ATTACK_HEIGHT_MID, /*Hitlag*/ 14, /*Blocklag*/ 20, /*Hitstun*/ 20, /*Blockstun*/ 20, /*Hit Pushback*/ 0.0, /*Block Pushback*/ 20.0, /*Hit Status*/ HIT_STATUS_LAUNCH, /*Counterhit Status*/ HIT_STATUS_LAUNCH, COUNTERHIT_TYPE_NORMAL, /*Juggle Start*/ 6, /*Juggle Increase*/ 1, /*Juggle Max*/ 8, CLANK_KIND_NORMAL, DAMAGE_KIND_CHIP_KO, /*Continue Launch*/ true, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 49.0, 2.0, 22.0, 10.0);
			}
		});
		execute_frame(8, [this]() {
