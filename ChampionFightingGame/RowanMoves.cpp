...
void Rowan::load_move_list() {
	...
	move_list[FIGHTER_SITUATION_GROUND].add_movelist_entry("stand_mp_crouch_hp", FIGHTER_STATUS_ATTACK,
...
void Rowan::load_move_scripts() {
	...
	script("jump", [this]() {
		execute_frame(0, [this]() {
			push_function(&Fighter::NEW_PUSHBOX, 0, glm::vec2(-30.0, 80.0), glm::vec2(70.0, 160.0));
			push_function(&Fighter::NEW_HURTBOX, 0, glm::vec2(-80, 90), glm::vec2(120, 180), HURTBOX_KIND_NORMAL, 0, INTANGIBLE_KIND_NONE);
		});
		execute_wait(1, [this]() {
			push_function(&Fighter::NEW_HURTBOX, 0, glm::vec2(-80, 75), glm::vec2(120, 180), HURTBOX_KIND_NORMAL, 0, INTANGIBLE_KIND_NONE);
		});
		execute_wait(1, [this]() {
			push_function(&Fighter::NEW_HURTBOX, 0, glm::vec2(-80, 60), glm::vec2(120, 180), HURTBOX_KIND_NORMAL, 0, INTANGIBLE_KIND_NONE);
		});
		execute_wait(1, [this]() {
			push_function(&Fighter::NEW_HURTBOX, 0, glm::vec2(-80, 45), glm::vec2(120, 180), HURTBOX_KIND_NORMAL, 0, INTANGIBLE_KIND_NONE);
		});
		execute_wait(1, [this]() {
			push_function(&Fighter::NEW_HURTBOX, 0, glm::vec2(-80, 30), glm::vec2(120, 180), HURTBOX_KIND_NORMAL, 0, INTANGIBLE_KIND_NONE);
		});
		execute_wait(1, [this]() {
			push_function(&Fighter::NEW_HURTBOX, 0, glm::vec2(-80, 15), glm::vec2(120, 180), HURTBOX_KIND_NORMAL, 0, INTANGIBLE_KIND_NONE);
		});
		execute_wait(1, [this]() {
			push_function(&Fighter::NEW_HURTBOX, 0, glm::vec2(-80, 0), glm::vec2(120, 180), HURTBOX_KIND_NORMAL, 0, INTANGIBLE_KIND_NONE);
		});
	...
	script("stand_lk", [this]() {
		...
		execute_frame(4, [this]() {
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(250, 57), 
				glm::vec2(13, 4), COLLISION_KIND_GROUND, HitResult().damage(30).meter(18).hit(8, 13)
				.block(8, 8).anims("light_low", "light_mid", "low", "low"), HIT_STATUS_NORMAL, 
				HitMove().ground(8.0, 8.0).frames(7), HIT_FLAG_NONE, CRITICAL_CONDITION_NONE, 
	...
	script("stand_hk", [this]() {
		...
		execute_frame(7.0, [this]() {
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(52, 82), 
				glm::vec2(163, 137), COLLISION_KIND_GROUND | COLLISION_KIND_AIR,
				HitResult().damage(60).meter(36).hit(6, 20).block(6, 9).j_start(4).j_inc(2)
				.j_max(2).anims("heavy_high", "heavy_high", "high", "mid"), HIT_STATUS_NORMAL, 
				HitMove().ground(13.0, 6.0).air(2.0, 31.0).frames(5).launch(25.0, 1.3, 15.0, 3.0),
		...
		execute_frame(12.0, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 1, glm::vec2(60, 95), 
				...
				HitResult().damage(30).start_scale(0.9f).meter(18).hit(6, 24).block(6, 5)
				.anims("heavy_high", "heavy_high", "high", "mid").j_inc(1).j_max(3),
				HIT_STATUS_NORMAL, HitMove().ground(20.0, 10.0).air(3.0, 31.0).frames(10)
				.launch(50.0, 1.3, 15.0, 1.0), HIT_FLAG_CONTINUE_LAUNCH, CRITICAL_CONDITION_NONE, 
				HIT_HEIGHT_MID, DAMAGE_KIND_NORMAL, "", ""
			);
	...
	script("crouch_lp", [this]() {
		...
		execute_frame(2, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(50, 51), 
				...
				HitResult().damage(30).meter(18).hit(6, 13).block(6, 5).j_min(1)
	...
	script("crouch_mp", [this]() {
		...
		execute_wait(2, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(145, 40), 
				glm::vec2(320, 120), COLLISION_KIND_GROUND, HitResult().damage(60).meter(36).hit(10, 22)
				.block(12, 17).anims("medium_mid", "medium_mid", "mid", "mid"), HIT_STATUS_NORMAL, 
				HitMove().ground(8.0, 8.0).frames(11), HIT_FLAG_NONE, CRITICAL_CONDITION_NONE, 
				HIT_HEIGHT_MID, DAMAGE_KIND_NORMAL, "", ""
			);
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 0, glm::vec2(255, 120), 
				glm::vec2(355, 165), COLLISION_KIND_AIR, HitResult().damage(60).meter(36).hit(10, 22)
				.j_start(1).j_inc(1).j_max(3), HIT_STATUS_NORMAL, HitMove().air(10.0, 18.0).frames(8), 
				HIT_FLAG_NONE, CRITICAL_CONDITION_NONE, HIT_HEIGHT_MID, 
				DAMAGE_KIND_NORMAL, "", ""
			);
		});
		execute_wait(4, [this]() {
	...
	script("crouch_hp", [this]() {
		...
		execute_wait(2, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(51, 253), 
				glm::vec2(180, 70), COLLISION_KIND_GROUND | COLLISION_KIND_AIR, 
	...
	script("crouch_lk", [this]() {
		...
		execute_frame(3, [this]() {
			push_function(&Fighter::NEW_HURTBOX, 1, glm::vec2(120, 0), glm::vec2(235, 50), HURTBOX_KIND_NORMAL, 0, INTANGIBLE_KIND_NONE);
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(230, 36), 
				glm::vec2(129, -7), COLLISION_KIND_GROUND, HitResult().damage(30).meter(18).hit(8, 11)
	...
	script("crouch_mk", [this]() {
		...
		execute_frame(6, [this]() {
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(293, -10), 
				glm::vec2(14, 42), COLLISION_KIND_GROUND, HitResult().damage(60).meter(36).hit(10, 19)
				...
				HIT_HEIGHT_LOW, DAMAGE_KIND_NORMAL, "", ""
			);
		});
		execute_wait(5, [this]() {
			push_function(&Fighter::DISABLE_ALL_CANCELS);
	...
	script("crouch_hk", [this]() {
		...
		execute_frame(8, [this]() {
			...
			CRITICAL_CONDITION_NONE, HIT_HEIGHT_LOW, DAMAGE_KIND_NORMAL, "", "");
		});
		execute_wait(2, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_PUNISH, true);
	...
	script("jump_lp", [this]() {
		...
		execute_frame(3, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(60, 15), 
				...
				HitResult().damage(30).meter(18).hit(8, 16).block(8, 13).j_start(1).j_inc(1).j_max(4)
				.anims("light_high", "light_high", "high", ""), HIT_STATUS_NORMAL,
				HitMove().ground(15.0, 15.0).air(5.0, 18.0).frames(8), HIT_FLAG_NONE, 
				CRITICAL_CONDITION_NONE, HIT_HEIGHT_HIGH, DAMAGE_KIND_NORMAL, "", ""
			);
		});
		execute_wait(8, [this]() {
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("jump_mp", [this]() {
		...
		execute_frame(6, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(90, 5), 
				glm::vec2(215, 50), COLLISION_KIND_GROUND | COLLISION_KIND_AIR, 
				HitResult().damage(40).meter(24).hit(10, 21).block(12, 26).j_start(1).j_inc(1).j_max(5)
				.anims("medium_high", "medium_high", "high", ""), HIT_STATUS_NORMAL,
				HitMove().ground(22.0, 22.0).air(8.0, 13.0).frames(11), HIT_FLAG_NONE, 
				CRITICAL_CONDITION_NONE, HIT_HEIGHT_HIGH, DAMAGE_KIND_NORMAL, "", ""
			);
		});
		execute_wait(8, [this]() {
	...
	script("jump_hp", [this]() {
		...
		execute_frame(8, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(-5, 102),
				glm::vec2(277, 178), COLLISION_KIND_AIR, 
				HitResult().damage(50).meter(30).hit(12, 0).j_start(1).j_inc(1).j_max(6),
				HIT_STATUS_LAUNCH, HitMove().launch(-20.0, 0.0, 15.0, 5.0), HIT_FLAG_NONE, 
				CRITICAL_CONDITION_NONE, HIT_HEIGHT_HIGH, DAMAGE_KIND_NORMAL, "", ""
			);
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 0, glm::vec2(105, 74), 
				glm::vec2(298, 137), COLLISION_KIND_GROUND, 
				HitResult().damage(50).meter(40).hit(12, 25).block(12, 25).j_start(1)
				.anims("heavy_high", "heavy_high", "high", ""), HIT_STATUS_NORMAL, 
				HitMove().ground(15.0, 15.0).frames(12), HIT_FLAG_NONE, CRITICAL_CONDITION_COUNTERHIT, 
				HIT_STATUS_LAUNCH, HitMove().launch(20.0, 1.3, 15.0, 5.0), HIT_FLAG_HARD_KNOCKDOWN, 
	...
	script("jump_lk", [this]() {
		...
		execute_frame(4, [this]() {
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(87, 129), 
				glm::vec2(194, 225), COLLISION_KIND_GROUND, 
				HitResult().damage(30).meter(18).hit(8, 13).block(8, 17)
				.anims("light_high", "light_high", "high", ""), HIT_STATUS_NORMAL, 
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 0, glm::vec2(87, 129),
				glm::vec2(194, 225), COLLISION_KIND_AIR, 
				HitResult().damage(30).meter(18).hit(8, 13).j_start(3).j_inc(1).j_max(3),
				HIT_STATUS_NORMAL, HitMove().air(5.0, 13.0).frames(7), HIT_FLAG_NONE, 
				CRITICAL_CONDITION_PUNISH, HIT_STATUS_LAUNCH, HitMove().launch(25.0, 1.0, 10.0, 5.0),
				HIT_FLAG_NONE, HIT_HEIGHT_HIGH, DAMAGE_KIND_NORMAL, "", ""
			);
		});
		execute_wait(3, [this]() {
			push_function(&Fighter::CLEAR_HITBOX_ALL);
	...
	script("jump_mk", [this]() {
		...
		execute_frame(6, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(-103, 59), 
				glm::vec2(55, 10), COLLISION_KIND_GROUND | COLLISION_KIND_AIR, 
				HitResult().damage(40).meter(24).hit(10, 23).block(10, 18).j_start(1).j_inc(1).j_max(2)
				.anims("medium_high", "medium_high", "high", ""), HIT_STATUS_NORMAL,
				HitMove().ground(15.0, 15.0).air(5.0, 15.0).frames(5), HIT_FLAG_NONE, 
				CRITICAL_CONDITION_NONE, HIT_HEIGHT_HIGH, DAMAGE_KIND_NORMAL, "", ""
			);
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 0, glm::vec2(-46, 90), 
				glm::vec2(248, 43), COLLISION_KIND_GROUND | COLLISION_KIND_AIR, 
				HitResult().damage(40).meter(24).hit(10, 23).block(10, 18).j_start(1).j_inc(1).j_max(2)
				.anims("medium_high", "medium_high", "high", ""), HIT_STATUS_NORMAL,
				HitMove().ground(15.0, 15.0).air(5.0, 10.0).frames(5), HIT_FLAG_NONE,
				CRITICAL_CONDITION_NONE, HIT_HEIGHT_HIGH, DAMAGE_KIND_NORMAL, "", ""
			);
		});
		execute_wait(5, [this]() {
	...
	script("jump_hk", [this]() {
		...
		execute_frame(9, [this]() {
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(250, 60), 
				...
				HitResult().damage(50).meter(30).hit(12, 15).block(12, 11).j_start(1).j_inc(1).j_max(2)
				.anims("heavy_high", "heavy_high", "high", ""), HIT_STATUS_NORMAL,
				HitMove().ground(15.0, 15.0).air(5.0, 15.0).frames(15), HIT_FLAG_NONE, 
				CRITICAL_CONDITION_NONE, HIT_HEIGHT_HIGH, DAMAGE_KIND_NORMAL, "", ""
			);
		});
		execute_wait(6, [this]() {
	...
	script("backdash_attack", [this]() {
		...
		execute_frame(8, [this]() {
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(300, 190), 
				...
				HIT_FLAG_HARD_KNOCKDOWN, HIT_HEIGHT_MID, DAMAGE_KIND_NORMAL, "", ""
			);
		});
		execute_wait(2, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
	...
	script("advance_high", [this]() {
		...
		execute_frame(19, [this]() {
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(226, 114), 
				...
				HitResult().damage(120).meter(72).hit(14, 180).block(20, 5).j_start(0).j_inc(1).j_max(4)
	...
	script("special_slide", [this]() {
		...
		execute_frame(3, [this]() {
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] != SPECIAL_LEVEL_H) {
				push_function(&Fighter::NEW_PUSHBOX, 1, glm::vec2(-30.0, 0.0), glm::vec2(70.0, 25.0));
			}
		});
		execute_frame(6, [this]() {
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] != SPECIAL_LEVEL_H) {
				push_function(&Fighter::NEW_PUSHBOX, 1, glm::vec2(-30, 0), glm::vec2(120, 25));
			}
		});
		execute_frame(9, [this]() {
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] != SPECIAL_LEVEL_H) {
				push_function(&Fighter::NEW_PUSHBOX, 1, glm::vec2(-30, 0), glm::vec2(170, 25));
			}
		});
		execute_frame(12, [this]() {
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] != SPECIAL_LEVEL_H) {
				push_function(&Fighter::NEW_PUSHBOX, 1, glm::vec2(-135, 0), glm::vec2(220, 25));
			}
			else {
	...
	script("special_slide_followup", [this]() {
		...
		execute_frame(8.0, [this]() {
			if (fighter_int[FIGHTER_INT_SPECIAL_LEVEL] == SPECIAL_LEVEL_EX) {
				...
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, glm::vec2(62, 45),
					glm::vec2(201, 236), COLLISION_KIND_AIR, HitResult().damage(70).meter(56).hit(12, 0)
					.j_inc(1).j_max(4), HIT_STATUS_LAUNCH, HitMove().launch(28.0, 2.0, 18.0, 0.5), 
					HIT_FLAG_NONE, CRITICAL_CONDITION_NONE, HIT_HEIGHT_MID, DAMAGE_KIND_NORMAL, "", ""
				);
				push_function(&Fighter::NEW_HITBOX, /*ID*/ 1, /*Multihit ID*/ 0, glm::vec2(62, 45),
