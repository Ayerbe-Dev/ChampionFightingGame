...
void Rowan::load_move_scripts() {
	...
	script("stand_lk", [this]() {
		...
		execute_frame(4, [this]() {
			...
			push_function(&Fighter::NEW_HITBOX, /*ID*/ 0, /*Multihit ID*/ 0, /*Damage*/ 30.0, /*Chip Damage*/ 6.0, /*Damage Scale*/ 1, /*Meter Gain*/ 24.0, glm::vec2(250, 57), glm::vec2(13, 4), HIT_KIND_GROUND, ATTACK_LEVEL_LIGHT, ATTACK_HEIGHT_MID, /*Hitlag*/ 8, /*Blocklag*/ 8, /*Hitstun*/ 12, /*Blockstun*/ 10, /*Hit Pushback*/ 10.0, /*Block Pushback*/ 10.0, /*Hit Status*/ HIT_STATUS_NORMAL, /*Counterhit Status*/ HIT_STATUS_NORMAL, COUNTERHIT_TYPE_COUNTER, /*Juggle Start*/ 0, /*Juggle Increase*/ 1, /*Juggle Max*/ 0, CLANK_KIND_NORMAL, DAMAGE_KIND_NORMAL, /*Continue Launch*/ false, /*Disable Hitstun Parry*/ false, /*Launch Info*/ 10.0, 0.0, 0.0, 1.0);
		});
		execute_wait(3, [this]() {
			push_function(&Fighter::SET_FLAG, FIGHTER_FLAG_ENABLE_COUNTERHIT, false);
			push_function(&Fighter::CLEAR_HITBOX_ALL);
