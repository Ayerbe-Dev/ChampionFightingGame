...
Zyair::Zyair(int id, PlayerInfo* player_info, FighterAccessor* fighter_accessor) {
	...
	this->base_texture = loadTexture("resource/chara/zyair/sprite/sprite.png");
...
bool Zyair::specific_ground_status_act() {
	return false;
}

bool Zyair::specific_air_status_act() {
	return false;
}

bool Zyair::specific_status_attack() {
