...
enum
{
	...
	CHARA_STATUS_UNIQUE_1,
	CHARA_STATUS_UNIQUE_2,
	CHARA_STATUS_UNIQUE_3,

	CHARA_STATUS_MAX,
};

enum {
	CHARA_ROY_STATUS_FIREBALL_START = CHARA_STATUS_UNIQUE_1,
...
enum {
	CHARA_ERIC_STATUS_FIREBALL = CHARA_STATUS_UNIQUE_1,
